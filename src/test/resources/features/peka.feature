@featureTest
Feature: Login page on peka site
  I want to test pay tportmonetka
...
#    tworzenie pakietu peka.login
#    utworzenie klasy o nazwie PekaLoginStepDef
#  przekopiowanie pierwszego kroku